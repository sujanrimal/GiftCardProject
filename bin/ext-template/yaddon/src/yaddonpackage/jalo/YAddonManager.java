...
import yaddonpackage.constants.YAddonConstants;



/**
 * This is the extension manager of the YAddon extension.
 */
public class YAddonManager extends GeneratedYAddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YAddonManager.class.getName());
	 ...
	 */
	public static YAddonManager getInstance()
	{
		return (YAddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				YAddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YAddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YAddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YAddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YAddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
