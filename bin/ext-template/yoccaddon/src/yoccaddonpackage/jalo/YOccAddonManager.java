...
import yoccaddonpackage.constants.YOccAddonConstants;



/**
 * This is the extension manager of the yoccaddon extension.
 */
public class YOccAddonManager extends GeneratedYOccAddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YOccAddonManager.class.getName());
	 ...
	 */
	public YOccAddonManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YOccAddonManager called.");
		}
	}
	 ...
	 */
	public static YOccAddonManager getInstance()
	{
		return (YOccAddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(YOccAddonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YOccAddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YOccAddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
