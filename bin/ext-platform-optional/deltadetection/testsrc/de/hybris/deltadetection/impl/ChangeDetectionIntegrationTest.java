...
public class ChangeDetectionIntegrationTest extends ServicelayerBaseTest
{
	...
	public void shouldTreatItemVersionMarkerAsSLDSafeForWriting()
	{
		...
		final boolean isSLDSafe = PersistenceUtils.doWithSLDPersistence(
				() -> jaloAccessorsService.isSLDSafeForWrite(ItemVersionMarkerModel._TYPECODE));

		assertThat(isSLDSafe).isTrue();
	}
