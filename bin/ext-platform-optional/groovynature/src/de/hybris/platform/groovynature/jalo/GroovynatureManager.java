...
/**
 * This is the extension manager of the Groovynature extension.
 */
public class GroovynatureManager extends GeneratedGroovynatureManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(GroovynatureManager.class.getName());
	 ...
	 */
	public static GroovynatureManager getInstance()
	{
		return (GroovynatureManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				GroovynatureConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GroovynatureManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GroovynatureManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of GroovynatureManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of GroovynatureManager called, current tenant: " + getTenant().getTenantID());
		}
	}
