...
/**
 * This is the extension manager of the Y2ysyncdemoelectronics extension.
 */
public class Y2ysyncdemoelectronicsManager extends GeneratedY2ysyncdemoelectronicsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Y2ysyncdemoelectronicsManager.class.getName());
	 ...
	 */
	public static Y2ysyncdemoelectronicsManager getInstance()
	{
		return (Y2ysyncdemoelectronicsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Y2ysyncdemoelectronicsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Y2ysyncdemoelectronicsManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Y2ysyncdemoelectronicsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Y2ysyncdemoelectronicsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Y2ysyncdemoelectronicsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
