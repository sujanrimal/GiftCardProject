...
/**
 * This is the extension manager of the Xyformsstorefrontcommons extension.
 */
public class XyformsstorefrontcommonsManager extends GeneratedXyformsstorefrontcommonsManager
{
	 ...
	 */
	public static XyformsstorefrontcommonsManager getInstance()
	{
		return (XyformsstorefrontcommonsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(XyformsstorefrontcommonsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public XyformsstorefrontcommonsManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of XyformsstorefrontcommonsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of XyformsstorefrontcommonsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of XyformsstorefrontcommonsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
