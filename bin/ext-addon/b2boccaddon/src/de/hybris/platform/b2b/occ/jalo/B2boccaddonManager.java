 ...
 */
package de.hybris.platform.b2b.occ.jalo;
...
import de.hybris.platform.b2b.occ.constants.B2boccaddonConstants;
 ...
 */
public class B2boccaddonManager extends GeneratedB2boccaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2boccaddonManager.class.getName());
	 ...
	 */
	public static B2boccaddonManager getInstance()
	{
		return (B2boccaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				B2boccaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2boccaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2boccaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2boccaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2boccaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
