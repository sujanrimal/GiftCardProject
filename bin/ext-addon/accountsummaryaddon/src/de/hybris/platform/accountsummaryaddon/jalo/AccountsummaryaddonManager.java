...
public class AccountsummaryaddonManager extends GeneratedAccountsummaryaddonManager
{
	...
	private static final Logger LOG = Logger.getLogger(AccountsummaryaddonManager.class.getName());
	 ...
	 */
	public static AccountsummaryaddonManager getInstance()
	{
		return (AccountsummaryaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AccountsummaryaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AccountsummaryaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AccountsummaryManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AccountsummaryManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AccountsummaryManager called, current tenant: " + getTenant().getTenantID());
		}
	}
