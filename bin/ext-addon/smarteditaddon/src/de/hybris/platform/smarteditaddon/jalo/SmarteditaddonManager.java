...
/**
 * This is the extension manager of the Smarteditaddon extension.
 */
public class SmarteditaddonManager extends GeneratedSmarteditaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SmarteditaddonManager.class.getName());
	 ...
	 */
	public static SmarteditaddonManager getInstance()
	{
		return (SmarteditaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SmarteditaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SmarteditaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SmarteditaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SmarteditaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SmarteditaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
