 ...
 */
package de.hybris.platform.hybrisanalyticsaddon.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.hybrisanalyticsaddon.constants.HybrisanalyticsaddonConstants;
...
/**
 * This is the extension manager of the Hybrisanalyticsaddon extension.
 */
public class HybrisanalyticsaddonManager extends GeneratedHybrisanalyticsaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(HybrisanalyticsaddonManager.class.getName());
	 ...
	 */
	public static HybrisanalyticsaddonManager getInstance()
	{
		return (HybrisanalyticsaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(HybrisanalyticsaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HybrisanalyticsaddonManager() // NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of HybrisanalyticsaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of HybrisanalyticsaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of HybrisanalyticsaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
