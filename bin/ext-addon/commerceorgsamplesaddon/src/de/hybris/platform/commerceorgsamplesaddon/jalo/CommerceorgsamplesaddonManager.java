 ...
 */
public class CommerceorgsamplesaddonManager extends GeneratedCommerceorgsamplesaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CommerceorgsamplesaddonManager.class.getName());
	 ...
	 */
	public static CommerceorgsamplesaddonManager getInstance()
	{
		return (CommerceorgsamplesaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CommerceorgsamplesaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CommerceorgsamplesaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CommerceorgsamplesaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CommerceorgsamplesaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CommerceorgsamplesaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
