...
/**
 * This is the extension manager of the B2bpunchoutaddon extension.
 */
public class B2bpunchoutaddonManager extends GeneratedB2bpunchoutaddonManager
{
	 ...
	 */
	public static B2bpunchoutaddonManager getInstance()
	{
		return (B2bpunchoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(B2bpunchoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2bpunchoutaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2bpunchoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2bpunchoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2bpunchoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
