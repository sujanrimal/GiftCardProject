 ...
 */
public class CaptchaaddonManager extends GeneratedCaptchaaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CaptchaaddonManager.class.getName());
	 ...
	 */
	public static CaptchaaddonManager getInstance()
	{
		return (CaptchaaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CaptchaaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CaptchaaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CaptchaaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CaptchaaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CaptchaaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
