 ...
 */
package de.hybris.eventtracking.ws.jalo;

import de.hybris.eventtracking.ws.constants.EventtrackingwsaddonConstants;
...
/**
 * This is the extension manager of the Eventtrackingwsaddon extension.
 */
public class EventtrackingwsaddonManager extends GeneratedEventtrackingwsaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EventtrackingwsaddonManager.class.getName());
	 ...
	 */
	public static EventtrackingwsaddonManager getInstance()
	{
		return (EventtrackingwsaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EventtrackingwsaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EventtrackingwsaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EventtrackingwsaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EventtrackingwsaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EventtrackingwsaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
