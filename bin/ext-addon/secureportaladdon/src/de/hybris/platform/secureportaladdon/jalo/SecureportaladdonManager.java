...
/**
 * This is the extension manager of the Secureportaladdon extension.
 */
public class SecureportaladdonManager extends GeneratedSecureportaladdonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SecureportaladdonManager.class.getName());
	 ...
	 */
	public static SecureportaladdonManager getInstance()
	{
		return (SecureportaladdonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SecureportaladdonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SecureportaladdonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SecureportaladdonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SecureportaladdonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SecureportaladdonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
