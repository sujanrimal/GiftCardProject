...
/**
 * This is the extension manager of the Configurablebundleaddon extension.
 */
public class ConfigurablebundleaddonManager extends GeneratedConfigurablebundleaddonManager
{
	 ...
	 */
	public static ConfigurablebundleaddonManager getInstance()
	{
		return (ConfigurablebundleaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ConfigurablebundleaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ConfigurablebundleaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ConfigurablebundleaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ConfigurablebundleaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ConfigurablebundleaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
