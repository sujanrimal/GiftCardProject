...
/**
 * This is the extension manager of the Xyformssamples extension.
 */
public class XyformssamplesManager extends GeneratedXyformssamplesManager
{
	 ...
	 */
	public static XyformssamplesManager getInstance()
	{
		return (XyformssamplesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(XyformssamplesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public XyformssamplesManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of XyformssamplesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of XyformssamplesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of XyformssamplesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
