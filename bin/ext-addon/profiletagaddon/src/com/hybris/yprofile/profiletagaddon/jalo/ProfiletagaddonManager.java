...
/**
 * This is the extension manager of the Profiletagaddon extension.
 */
public class ProfiletagaddonManager extends GeneratedProfiletagaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ProfiletagaddonManager.class.getName());
	 ...
	 */
	public static ProfiletagaddonManager getInstance()
	{
		return (ProfiletagaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ProfiletagaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProfiletagaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ProfiletagaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ProfiletagaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ProfiletagaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
