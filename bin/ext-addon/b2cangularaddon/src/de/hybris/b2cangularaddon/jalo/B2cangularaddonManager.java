 ...
 */
package de.hybris.b2cangularaddon.jalo;
...
import de.hybris.b2cangularaddon.constants.B2cangularaddonConstants;



/**
 * This is the extension manager of the B2cangularaddon extension.
 */
public class B2cangularaddonManager extends GeneratedB2cangularaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2cangularaddonManager.class.getName());
	 ...
	 */
	public static B2cangularaddonManager getInstance()
	{
		return (B2cangularaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				B2cangularaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2cangularaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2cangularaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2cangularaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2cangularaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
