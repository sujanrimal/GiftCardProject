...
public class AcceleratorwebservicesaddonManager extends GeneratedAcceleratorwebservicesaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AcceleratorwebservicesaddonManager.class.getName());
	 ...
	 */
	public AcceleratorwebservicesaddonManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AcceleratorwebservicesaddonManager called.");
		}
	}
	 ...
	 */
	public static AcceleratorwebservicesaddonManager getInstance()
	{
		return (AcceleratorwebservicesaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AcceleratorwebservicesaddonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AcceleratorwebservicesaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AcceleratorwebservicesaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
