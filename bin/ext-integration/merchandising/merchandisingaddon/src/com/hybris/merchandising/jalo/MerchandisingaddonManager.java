...
/**
 * This is the extension manager of the Merchandisingaddon extension.
 */
public class MerchandisingaddonManager extends GeneratedMerchandisingaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MerchandisingaddonManager.class.getName());
	 ...
	 */
	public MerchandisingaddonManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MerchandisingaddonManager called.");
		}
	}
	 ...
	 */
	public static MerchandisingaddonManager getInstance()
	{
		return (MerchandisingaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MerchandisingaddonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MerchandisingaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MerchandisingaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
