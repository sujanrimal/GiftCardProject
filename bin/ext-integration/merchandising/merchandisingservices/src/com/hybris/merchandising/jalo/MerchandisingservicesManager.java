...
/**
 * This is the extension manager of the Merchandisingservices extension.
 */
public class MerchandisingservicesManager extends GeneratedMerchandisingservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MerchandisingservicesManager.class);
	 ...
	 */
	public MerchandisingservicesManager()
	{
		LOG.debug("constructor of MerchandisingservicesManager called.");
	}
	 ...
	 */
	public static MerchandisingservicesManager getInstance()
	{
		return (MerchandisingservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MerchandisingservicesConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		LOG.debug("init() of MerchandisingservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MerchandisingservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
