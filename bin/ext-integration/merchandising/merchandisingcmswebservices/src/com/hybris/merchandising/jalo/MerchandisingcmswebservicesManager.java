...
/**
 * This is the extension manager of the Merchandisingcmswebservices extension.
 */
public class MerchandisingcmswebservicesManager extends GeneratedMerchandisingcmswebservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MerchandisingcmswebservicesManager.class);
	 ...
	 */
	public MerchandisingcmswebservicesManager()
	{
		LOG.debug("constructor of MerchcmswebservicesManager called.");
	}
	 ...
	 */
	public static MerchandisingcmswebservicesManager getInstance()
	{
		return (MerchandisingcmswebservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MerchandisingcmswebservicesConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		LOG.debug("init() of MerchcmswebservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MerchcmswebservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
