...
class GetEntitiesIntegrationTest extends ServicelayerSpockSpecification {
    ...
    def "get collection of enums"() throws ImpExException
    {
        ...
        IntegrationTestUtil.importImpEx(
                "INSERT_UPDATE IntegrationObjectItem; integrationObject(code)[unique = true]; code[unique = true]                         ; type(code)",
                "                                   ; InboundProduct                        ; TestIntegrationItem                         ; TestIntegrationItem",
                "                                   ; InboundProduct                        ; OData2webservicesFeatureTestPropertiesTypes ; OData2webservicesFeatureTestPropertiesTypes",
                "INSERT_UPDATE IntegrationObjectItemAttribute ; integrationObjectItem(integrationObject(code), code)[unique = true] ; attributeName[unique = true] ; attributeDescriptor(enclosingType(code), qualifier) ; returnIntegrationObjectItem(integrationObject(code), code)  ; unique[default = false]",
                "                                             ; InboundProduct:TestIntegrationItem                                  ; code                         ; TestIntegrationItem:code",
                "                                             ; InboundProduct:TestIntegrationItem                                  ; testEnums                    ; TestIntegrationItem:testEnums                       ; InboundProduct:OData2webservicesFeatureTestPropertiesTypes  ; false",
                "                                             ; InboundProduct:OData2webservicesFeatureTestPropertiesTypes          ; code                         ; OData2webservicesFeatureTestPropertiesTypes:code",
        ...
        def response = basicAuthRequest("InboundProduct/TestIntegrationItems('$itemKey')/testEnums")
                .build()
                .accept(MediaType.APPLICATION_JSON_TYPE)
                .get()
