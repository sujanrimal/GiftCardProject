...
public abstract class GeneratedTestIntegrationItemDetail extends TestItem
{
	...
	/** Qualifier of the <code>TestIntegrationItemDetail.testEnum</code> attribute **/
	...
	**/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>TestIntegrationItemDetail.testEnum</code> attribute.
	 * @return the testEnum
	 */
	public EnumerationValue getTestEnum(final SessionContext ctx)
	{
		return (EnumerationValue)getProperty( ctx, TESTENUM);
	}
	 ...
	 * @return the testEnum
	 */
	public EnumerationValue getTestEnum()
	{
		return getTestEnum( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>TestIntegrationItemDetail.testEnum</code> attribute. 
	 * @param value the testEnum
	 */
	public void setTestEnum(final SessionContext ctx, final EnumerationValue value)
	{
		setProperty(ctx, TESTENUM,value);
	}
	 ...
	 * @param value the testEnum
	 */
	public void setTestEnum(final EnumerationValue value)
	{
		setTestEnum( getSession().getSessionContext(), value );
	}
