...
public class DefaultMapToIntegrationKeyGeneratorUnitTest
{
	...
	private final DefaultMapToIntegrationKeyGenerator integrationKeyGenerator = new DefaultMapToIntegrationKeyGenerator();
	...
	private KeyAttribute keyAttribute(final String type, final String property)
	{
		...
		final IntegrationObjectItemAttributeModel attribute = mock(IntegrationObjectItemAttributeModel.class, type + ":" + property);
