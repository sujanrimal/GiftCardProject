 ...
 */
public class DefaultMapType2MapPopulator extends AbstractItem2MapPopulator<Object>
{
			...
			final Map<String, Object> target)
	{
		if (attr.isLocalized())
		{
			...
			final Object value = getModelService().getAttributeValue(itemModel, attr.getQualifier(), getI18NService().getCurrentLocale());
