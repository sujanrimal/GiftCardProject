 ...
 */
public class DefaultEnumerationMetaType2MapPopulator extends AbstractItem2MapPopulator<HybrisEnumValue>
{
	...
	{
		final HybrisEnumValue value = getAttributeValue(context, attribute);
		if (value != null)
		{
			final Map<String, Object> map = attribute.getAttributeType().getAttributes().stream()
	...
	{
		return attributeDescriptor.getAttributeType().isEnumeration();
	}
}
