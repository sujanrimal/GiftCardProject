...
{
	private IntegrationKeyGenerator<TypeDescriptor, Map<String, Object>> integrationKeyValueGenerator;
	...
	protected IntegrationKeyGenerator<TypeDescriptor, Map<String, Object>> getIntegrationKeyValueGenerator()
	{
		return integrationKeyValueGenerator;
	}

	@Required
	public void setIntegrationKeyValueGenerator(final IntegrationKeyGenerator<TypeDescriptor, Map<String, Object>> generator)
	{
