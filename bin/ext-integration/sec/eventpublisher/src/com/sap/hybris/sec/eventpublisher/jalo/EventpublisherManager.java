...
/**
 * This is the extension manager of the Eventpublisher extension.
 */
public class EventpublisherManager extends GeneratedEventpublisherManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(EventpublisherManager.class);
	...
	{
		return (EventpublisherManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(EventpublisherConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EventpublisherManager() // NOPMD 
	{
		LOG.debug("constructor of EventpublisherManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of EventpublisherManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of EventpublisherManager called, current tenant: {}", getTenant().getTenantID());
	}
