 ...
 */
package com.sap.hybris.sec.sso.jalo;
...
/**
 * This is the extension manager of the Samlcommercesecsso extension.
 */
public class SamlcommercesecssoManager extends GeneratedSamlcommercesecssoManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SamlcommercesecssoManager.class);
	 ...
	 */
	public static SamlcommercesecssoManager getInstance()
	{
		return (SamlcommercesecssoManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SamlcommercesecssoConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SamlcommercesecssoManager() // NOPMD 
	{
		LOG.debug("constructor of SamlcommercesecssoManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SamlcommercesecssoManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SamlcommercesecssoManager called, current tenant: {}", getTenant().getTenantID());
	}
