...
public class SapymktsegmentationwebservicesManager extends GeneratedSapymktsegmentationwebservicesManager
{
	...
	{
		return (SapymktsegmentationwebservicesManager) JaloSession.getCurrentSession().getExtensionManager()
				.getExtension(SapymktsegmentationwebservicesConstants.EXTENSIONNAME);
	}
}
