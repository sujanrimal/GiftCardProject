...
public class PropertyGeneratorUnitTest
{
	...
	private IntegrationObjectItemAttributeModel model()
	{
		...
		final IntegrationObjectModel object = new IntegrationObjectModel();
		object.setCode("IntegrationObject");

		final IntegrationObjectItemModel item = new IntegrationObjectItemModel();
		item.setAttributes(Collections.emptySet());
		item.setIntegrationObject(object);
		...
		model.setIntegrationObjectItem(item);
		return model;
	}
}