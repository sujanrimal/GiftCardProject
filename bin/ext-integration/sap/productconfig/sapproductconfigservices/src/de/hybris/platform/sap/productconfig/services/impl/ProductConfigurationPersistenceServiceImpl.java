...
public class ProductConfigurationPersistenceServiceImpl implements ProductConfigurationPersistenceService
{
	...
	static final String SELECT_ORPHANED = "select {pc.pk} from {ProductConfiguration as pc left outer JOIN Product2ProductConfigs as p2pc on {pc:pk} = {p2pc:target}} where {p2pc:target} is null and NOT EXISTS ({{SELECT {pk} from {AbstractOrderEntry} WHERE {productconfiguration} = {pc.PK} OR {productconfigurationdraft} = {pc.PK}}})";
