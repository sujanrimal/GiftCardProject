...
public class DefaultProfileTransactionServiceTest {
    ...
    public void verifyOrderIsSentToProfile() {
        ...
        when(profileClient.sendTransaction(anyString(), anyString(), anyString(),anyString(),any(AbstractProfileEvent.class))).thenReturn(Observable.just(rawResponse));
        ...
        verify(profileClient, times(1)).sendTransaction(matches("profile-commerce-order"),
                matches(CONSENT_REFERENCE), matches(SITE_ID),  matches("1"), any(Order.class));
    ...
    public void verifyOrderIsNotSentToProfileWhenProfileTrackingIsPaused() {
        ...
        verify(profileClient, never()).sendTransaction(anyString(), anyString(), anyString(), anyString(), any(Order.class));
    }
    ...
    public void verifyUserRegistrationIsSentProfile() {
        ...
        verify(profileClient, times(1)).sendTransaction(matches("account-registration"),
                matches(CONSENT_REFERENCE), matches(SITE_ID), matches("1"), any(User.class));
    }
    ...
    public void verifyUidChangedIsSentToProfile() {
        ...
        when(profileClient.sendSlimEvent(anyString(), anyString(), anyString(),anyString(),any(AbstractProfileEvent.class))).thenReturn(Observable.just(rawResponse));
        when(rawResponse.getStatusCode()).thenReturn(201);
        when(rawResponse.header(HYBRIS_CONTEXT_TRACE_ID_HEADER)).thenReturn(Optional.of("hybris-context-trace-id"));
    ...
    public void verifyUidChangedIsNotSentToProfileWhenProfileTrackingIsPaused() {
        ...
        verify(profileClient, never()).sendSlimEvent(anyString(), anyString(), anyString(), anyString(), any(Order.class));
    ...
    public void verifyAddressSavedIsNotSentToProfileWhenProfileTrackingIsPaused() {
        ...
        verify(profileClient, never()).sendSlimEvent(anyString(), anyString(), anyString(), anyString(), any(User.class));
