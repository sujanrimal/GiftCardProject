...
/**
 * This is the extension manager of the Profileservices extension.
 */
public class ProfileservicesManager extends GeneratedProfileservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ProfileservicesManager.class);
	 ...
	 */
	public static ProfileservicesManager getInstance()
	{
		return (ProfileservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ProfileservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProfileservicesManager() // NOPMD 
	{
		LOG.debug("constructor of ProfileservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of ProfileservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of ProfileservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
