...
public class SecurityUtils
{
	...
	{
		final Collection<X509Certificate> certificateChain = (Collection<X509Certificate>) (new CertificateFactory()).engineGenerateCertificates(new ByteArrayInputStream(certBytes));
