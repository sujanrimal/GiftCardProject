...
/**
 * This is the extension manager of the Powertoolsstore extension.
 */
public class PowertoolsStoreManager extends GeneratedPowertoolsStoreManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(PowertoolsStoreManager.class.getName());
	 ...
	 */
	public static PowertoolsStoreManager getInstance()
	{
		return (PowertoolsStoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(PowertoolsStoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PowertoolsStoreManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PowertoolsStoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PowertoolsStoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PowertoolsStoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
