...
import de.hybris.platform.odata2webservicesfeaturetests.enums.TestSampleEnum;
...
public class TestIntegrationItemDetailModel extends TestItemType2Model
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>TestIntegrationItemDetail.testEnum</code> attribute defined at extension <code>odata2webservicesfeaturetests</code>. */
	public static final String TESTENUM = "testEnum";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>TestIntegrationItemDetail.testEnum</code> attribute defined at extension <code>odata2webservicesfeaturetests</code>. 
	 * @return the testEnum
	 */
	@Accessor(qualifier = "testEnum", type = Accessor.Type.GETTER)
	public TestSampleEnum getTestEnum()
	{
		return getPersistenceContext().getPropertyValue(TESTENUM);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>TestIntegrationItemDetail.testEnum</code> attribute defined at extension <code>odata2webservicesfeaturetests</code>. 
	 *  
	 * @param value the testEnum
	 */
	@Accessor(qualifier = "testEnum", type = Accessor.Type.SETTER)
	public void setTestEnum(final TestSampleEnum value)
	{
		getPersistenceContext().setPropertyValue(TESTENUM, value);
	}
