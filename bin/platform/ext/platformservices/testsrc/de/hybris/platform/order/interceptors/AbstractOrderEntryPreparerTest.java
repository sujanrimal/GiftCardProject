...
import de.hybris.platform.servicelayer.internal.model.impl.DefaultTransientStorage;
...
public class AbstractOrderEntryPreparerTest
{
	...
	public void init()
	{
		...
		when(mockInterceptorContext.getTransientStorage()).thenReturn(new DefaultTransientStorage());
