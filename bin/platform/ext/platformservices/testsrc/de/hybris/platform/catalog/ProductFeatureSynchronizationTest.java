...
public class ProductFeatureSynchronizationTest extends ServicelayerBaseTest
{
	...
	public void setUp() throws Exception
	{
		...
		productAttributeAssignment = creator.createRefClassAttributeAssignment(classificationProductAttribute, classificationClass,
	...
	public void shouldSynchronizeProductWithAssignedProductFeatuerWhichHasAnotherProductAsValue()
	{
		...
		classificationService.setFeature(product1, new UnlocalizedFeature(productAttributeAssignment, new FeatureValue(product2)));
