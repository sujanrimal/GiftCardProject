...
public class XyformsbackofficeManager extends GeneratedXyformsbackofficeManager
{
	 ...
	 */
	public static XyformsbackofficeManager getInstance()
	{
		return (XyformsbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(XyformsbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public XyformsbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of XyformsbackofficeManager called.");
		}
	}
