...
public class BackofficeWidgetPersistenceServiceUnitTest
{
	...
	public void testResetToDefaults()
	{
		...
		doReturn(media).when(modelService).create(MediaModel.class);
	...
	public void testIsWidgetsConfigStoredInMedia()
	{
		...
		when(mediaService.getMedia(any(), eq(WIDGET_CONFIG_MEDIA))).thenReturn(media);
	...
	public void loadWidgetTreeTest()
	{
		...
		doReturn(media).when(mediaService).getMedia(any(), eq(WIDGET_CONFIG_MEDIA));
