...
public class IntegrationbackofficeManager extends GeneratedIntegrationbackofficeManager
{
	 ...
	 */
	public static IntegrationbackofficeManager getInstance()
	{
		return (IntegrationbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(IntegrationbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public IntegrationbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of IntegrationbackofficeManager called.");
		}
	}
