 ...
 */
package ybackofficepackage.jalo;
...
import ybackofficepackage.constants.YBackofficeConstants;
...
public class YBackofficeManager extends GeneratedYBackofficeManager
{
	 ...
	 */
	public static YBackofficeManager getInstance()
	{
		return (YBackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(YBackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YBackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YBackofficeManager called.");
		}
	}
