...
public class GeneratedNhogiftcardCoreConstants
{
	...
	public static class TC
	{
		...
		public static final String GIFTCARD = "GiftCard".intern();
		public static final String GIFTCARDTYPEENUM = "GiftCardTypeEnum".intern();
		public static final String GIFTCARDVARIANTPRODUCT = "GiftCardVariantProduct".intern();
	...
	{
		public static class GiftCardTypeEnum
		{
			public static final String GIFTCARD25 = "giftcard25".intern();
			public static final String GIFTCARD50 = "giftcard50".intern();
			public static final String GIFTCARD75 = "giftcard75".intern();
			public static final String GIFTCARD100 = "giftcard100".intern();
		}
	...
	protected GeneratedNhogiftcardCoreConstants()
	{
		// private constructor
	}
