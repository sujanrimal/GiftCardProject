...
public abstract class B2BMerchantCheck extends GeneratedB2BMerchantCheck
{
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger( B2BMerchantCheck.class.getName() );
