...
public class B2BMerchantCheckResult extends GeneratedB2BMerchantCheckResult
{
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger( B2BMerchantCheckResult.class.getName() );
