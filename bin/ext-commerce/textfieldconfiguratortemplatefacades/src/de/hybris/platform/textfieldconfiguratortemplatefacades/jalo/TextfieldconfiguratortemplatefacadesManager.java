...
/**
 * This is the extension manager of the Textfieldconfiguratortemplatefacades extension.
 */
public class TextfieldconfiguratortemplatefacadesManager extends GeneratedTextfieldconfiguratortemplatefacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TextfieldconfiguratortemplatefacadesManager.class.getName());
	 ...
	 */
	public static TextfieldconfiguratortemplatefacadesManager getInstance()
	{
		return (TextfieldconfiguratortemplatefacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TextfieldconfiguratortemplatefacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TextfieldconfiguratortemplatefacadesManager() // NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TextfieldconfiguratortemplatefacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TextfieldconfiguratortemplatefacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		...
		{
			LOG.debug(
					"destroy() of TextfieldconfiguratortemplatefacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
