...
/**
 * This is the extension manager of the Textfieldconfiguratortemplateservices extension.
 */
public class TextfieldconfiguratortemplateservicesManager extends GeneratedTextfieldconfiguratortemplateservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TextfieldconfiguratortemplateservicesManager.class.getName());
	 ...
	 */
	public static TextfieldconfiguratortemplateservicesManager getInstance()
	{
		return (TextfieldconfiguratortemplateservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TextfieldconfiguratortemplateservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TextfieldconfiguratortemplateservicesManager() // NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TextfieldconfiguratortemplateservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TextfieldconfiguratortemplateservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		...
		{
			LOG.debug(
					"destroy() of TextfieldconfiguratortemplateservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
