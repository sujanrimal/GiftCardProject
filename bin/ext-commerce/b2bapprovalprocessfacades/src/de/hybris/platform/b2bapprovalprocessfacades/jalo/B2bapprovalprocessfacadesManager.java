 ...
 */
public class B2bapprovalprocessfacadesManager extends GeneratedB2bapprovalprocessfacadesManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(B2bapprovalprocessfacadesManager.class.getName());
	 ...
	 */
	public static B2bapprovalprocessfacadesManager getInstance()
	{
		return (B2bapprovalprocessfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(B2bapprovalprocessfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2bapprovalprocessfacadesManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2bapprovalprocessfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2bapprovalprocessfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2bapprovalprocessfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
