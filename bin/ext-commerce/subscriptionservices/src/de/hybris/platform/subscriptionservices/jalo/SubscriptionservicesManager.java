...
/**
 * This is the extension manager of the Subscriptionservices extension.
 */
public class SubscriptionservicesManager extends GeneratedSubscriptionservicesManager
{
	 ...
	 */
	public static SubscriptionservicesManager getInstance()
	{
		return (SubscriptionservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SubscriptionservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SubscriptionservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SubscriptionservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SubscriptionservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SubscriptionservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
