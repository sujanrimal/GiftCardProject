...
/**
 * This is the extension manager of the Configurablebundlefacades extension.
 */
public class ConfigurablebundlefacadesManager extends GeneratedConfigurablebundlefacadesManager
{
	 ...
	 */
	public static ConfigurablebundlefacadesManager getInstance()
	{
		return (ConfigurablebundlefacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ConfigurablebundlefacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ConfigurablebundlefacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ConfigurablebundlefacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ConfigurablebundlefacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ConfigurablebundlefacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
