...
public class ConcurrentPromotionEngineServiceTest extends PromotionEngineServiceBaseTest
{
	...
	public void testConcurrentPromotionUpdate() throws Exception
	{
		...
		assertNotNull(user);
		final String fileName = legacyRRDMode ? "percentageDiscountCameraAccessories_rrd.drl"
				: "percentageDiscountCameraAccessories.drl";
		final AbstractRuleEngineRuleModel rule = getRuleForFile(fileName,
		...
		assertEquals(fileName, promoResult1.getPromotion().getCode());
