...
/**
 * This is the extension manager of the Xyformsfacades extension.
 */
public class XyformsfacadesManager extends GeneratedXyformsfacadesManager
{
	 ...
	 */
	public static XyformsfacadesManager getInstance()
	{
		return (XyformsfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(XyformsfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public XyformsfacadesManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of XyformsfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of XyformsfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of XyformsfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
