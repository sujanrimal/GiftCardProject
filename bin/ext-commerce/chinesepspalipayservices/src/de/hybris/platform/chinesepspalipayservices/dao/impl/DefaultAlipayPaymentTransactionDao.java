		...
		implements AlipayPaymentTransactionDao
{
	...
	public AlipayPaymentTransactionModel findTransactionByLatestRequestEntry(final OrderModel orderModel, final boolean limit)
	{
		...
		queryString.append("select {t.pk} from {" + AlipayPaymentTransactionModel._TYPECODE + " as t join "
				+ AlipayPaymentTransactionEntryModel._TYPECODE +" as entry on {t.PK} = {entry.paymenttransaction} } " +
		...
		query.addQueryParameter(PAYMENT_TRANSACTION_ENTRY_TYPE, PaymentTransactionType.REQUEST);
