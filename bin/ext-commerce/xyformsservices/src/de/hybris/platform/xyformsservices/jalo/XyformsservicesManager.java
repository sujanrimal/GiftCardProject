...
/**
 * This is the extension manager of the Xyformsservices extension.
 */
public class XyformsservicesManager extends GeneratedXyformsservicesManager
{
	 ...
	 */
	public static XyformsservicesManager getInstance()
	{
		return (XyformsservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(XyformsservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public XyformsservicesManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of XyformsservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of XyformsservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of XyformsservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
