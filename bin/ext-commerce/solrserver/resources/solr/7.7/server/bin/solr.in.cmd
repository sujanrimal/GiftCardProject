...
REM SOLR_AUTH_TYPE=basic
REM SOLR_AUTHENTICATION_OPTS="-Dbasicauth=solrserver:server123"

REM SOLR_SSL_ENABLED=true
REM SOLR_SSL_KEY_STORE_TYPE=JKS
REM SOLR_SSL_KEY_STORE=solr/solr.jks
REM SOLR_SSL_KEY_STORE_PASSWORD=123456
REM SOLR_SSL_TRUST_STORE_TYPE=JKS
REM SOLR_SSL_TRUST_STORE=solr/solr.jks
REM SOLR_SSL_TRUST_STORE_PASSWORD=123456
REM SOLR_SSL_NEED_CLIENT_AUTH=false
REM SOLR_SSL_WANT_CLIENT_AUTH=false

set SOLR_OPTS=%SOLR_OPTS% -Djdk.tls.client.protocols=TLSv1,TLSv1.1,TLSv1.2 -Dhttps.protocols=TLSv1,TLSv1.1,TLSv1.2
