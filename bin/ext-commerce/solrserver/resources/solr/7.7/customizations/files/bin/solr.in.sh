...
#SOLR_SSL_ENABLED=true
#SOLR_SSL_KEY_STORE_TYPE=JKS
#SOLR_SSL_KEY_STORE=solr/solr.jks
#SOLR_SSL_KEY_STORE_PASSWORD=123456
#SOLR_SSL_TRUST_STORE_TYPE=JKS
#SOLR_SSL_TRUST_STORE=solr/solr.jks
#SOLR_SSL_TRUST_STORE_PASSWORD=123456
#SOLR_SSL_NEED_CLIENT_AUTH=false
#SOLR_SSL_WANT_CLIENT_AUTH=false

SOLR_OPTS="$SOLR_OPTS -Djdk.tls.client.protocols=TLSv1,TLSv1.1,TLSv1.2 -Dhttps.protocols=TLSv1,TLSv1.1,TLSv1.2"
