...
public class OrbeonFormControllerTest
{
	...
	public void shouldResponseWithOkeyWithCreateSuccessed() throws YFormServiceException, IOException, ServletException
	{
		...
		given(yFormFacade.createYFormDefinition(applicationId, formId, newFormDefinition, null)).willReturn(yFormData);
	...
	public void shouldResponseEmptyStringIfYFormDataBodyEmpty() throws YFormServiceException, ServletException, IOException
	{
		...
		given(yFormFacade.getYFormData(anyString(), eq(YFormDataTypeEnum.DATA))).willReturn(yFormData);
		given(yFormFacade.getYFormData(anyString(), eq(YFormDataTypeEnum.DRAFT))).willReturn(yFormData);
