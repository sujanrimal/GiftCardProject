...
/**
 * This is the extension manager of the Xyformsweb extension.
 */
public class XyformswebManager extends GeneratedXyformswebManager
{
	 ...
	 */
	public static XyformswebManager getInstance()
	{
		return (XyformswebManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(XyformswebConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public XyformswebManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of XyformswebManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of XyformswebManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of XyformswebManager called, current tenant: " + getTenant().getTenantID());
		}
	}
