...
public class DefaultKieSessionHelperUnitTest
{
	...
	public void setUp()
	{
		...
		when(kieContainer.getKieBase()).thenReturn(kieBase);
		when(kieBase.newKieSessionsPool(anyInt())).thenReturn(kieSessionsPool);
		when(kieContainer.newKieSessionsPool(anyInt())).thenReturn(kieContainerSessionsPool);
		when(kieSessionsPool.newStatelessKieSession()).thenReturn(statelessKieSession);
		when(kieContainerSessionsPool.newKieSession()).thenReturn(kieSession);
