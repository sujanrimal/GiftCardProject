...
/**
 * This is the extension manager of the Entitlementfacades extension.
 */
public class EntitlementfacadesManager extends GeneratedEntitlementfacadesManager
{
	 ...
	 */
	public static EntitlementfacadesManager getInstance()
	{
		return (EntitlementfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EntitlementfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EntitlementfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EntitlementfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EntitlementfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EntitlementfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
