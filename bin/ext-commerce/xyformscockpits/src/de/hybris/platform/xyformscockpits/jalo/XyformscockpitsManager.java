...
*/
package de.hybris.platform.xyformscockpits.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.util.JspContext;
import de.hybris.platform.xyformscockpits.constants.XyformscockpitsConstants;
...
/**
 * This is the extension manager of the Xyformscockpits extension.
 */
public class XyformscockpitsManager extends GeneratedXyformscockpitsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(XyformscockpitsManager.class.getName());
	 ...
	 */
	public static XyformscockpitsManager getInstance()
	{
		return (XyformscockpitsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(XyformscockpitsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public XyformscockpitsManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of XyformscockpitsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of XyformscockpitsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of XyformscockpitsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
