...
/**
 * This is the extension manager of the Entitlementservices extension.
 */
public class EntitlementservicesManager extends GeneratedEntitlementservicesManager
{
	 ...
	 */
	public static EntitlementservicesManager getInstance()
	{
		return (EntitlementservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EntitlementservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EntitlementservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EntitlementservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EntitlementservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EntitlementservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
