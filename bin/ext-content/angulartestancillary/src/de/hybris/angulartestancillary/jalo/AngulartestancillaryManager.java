 ...
 */
package de.hybris.angulartestancillary.jalo;
...
import de.hybris.angulartestancillary.constants.AngulartestancillaryConstants;



/**
 * This is the extension manager of the Angulartestancillary extension.
 */
public class AngulartestancillaryManager extends GeneratedAngulartestancillaryManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(AngulartestancillaryManager.class);
	 ...
	 */
	public static AngulartestancillaryManager getInstance()
	{
		return (AngulartestancillaryManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AngulartestancillaryConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AngulartestancillaryManager() 
	{
		LOG.debug("constructor of AngulartestancillaryManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of AngulartestancillaryManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of AngulartestancillaryManager called, current tenant: {}", getTenant().getTenantID());
	}
