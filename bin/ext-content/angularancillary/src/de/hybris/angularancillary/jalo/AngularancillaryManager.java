 ...
 */
package de.hybris.angularancillary.jalo;
...
import de.hybris.angularancillary.constants.AngularancillaryConstants;



/**
 * This is the extension manager of the Angularancillary extension.
 */
public class AngularancillaryManager extends GeneratedAngularancillaryManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(AngularancillaryManager.class);
	 ...
	 */
	public static AngularancillaryManager getInstance()
	{
		return (AngularancillaryManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AngularancillaryConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AngularancillaryManager() 
	{
		LOG.debug("constructor of AngularancillaryManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of AngularancillaryManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of AngularancillaryManager called, current tenant: {}", getTenant().getTenantID());
	}
