 ...
 */
package com.hybris.ymkt.personalization.jalo;
...
import com.hybris.ymkt.personalization.constants.PersonalizationymktConstants;



/**
 * This is the extension manager of the Personalizationymkt extension.
 */
public class PersonalizationymktManager extends GeneratedPersonalizationymktManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(PersonalizationymktManager.class);
	 ...
	 */
	public static PersonalizationymktManager getInstance()
	{
		return (PersonalizationymktManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(PersonalizationymktConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PersonalizationymktManager() // NOPMD 
	{
		LOG.debug("constructor of PersonalizationymktManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of PersonalizationymktManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of PersonalizationymktManager called, current tenant: {}", getTenant().getTenantID());
	}
